...
\label{sec:orge728938}
\paragraph{Congénitales}
\label{sec:org72bda31}
...
\subsection{Étiologies}
\label{sec:org62a6f43}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org61a34d9}
Auto-immunes :
\begin{itemize}
...
\bottomrule
\end{tabular}
\end{table}\footnotetext[28]{\label{org821fa2d}Ou dans les valeurs des femmes jeunes}
...
\chapter{Pneumologie}
\label{sec:orgb166701}
\section{73 Addiction au tabac}
\label{sec:org508a64f}
...
tabagiques
\paragraph{Pathologies liées au tabac}
\label{sec:org77916b0}
\begin{itemize}
...
\subsection{Imagerie}
\label{sec:org94db4ff}
Initial = radio thorax chez fumeur > 40 ans
\subsubsection{Radiothorax}
\label{sec:org5bc8479}
...
\subsubsection{TDM injection}
\label{sec:orgf4005a5}
...
\chapter{Ophtalmologie}
\label{sec:org03dcd23}
\section{21 \textdagger{} Rétinopathie diabétique}
\label{sec:orgefe43b5}
\label{orgeb9d2f1}
