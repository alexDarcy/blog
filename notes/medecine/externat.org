...
#+caption: Hyperlipidémies
#+name: tab:hyperlipidémies
| Secondaire : étiologies                                | Primaire (classif)                    | Spéc.                  |
|--------------------------------------------------------+---------------------------------------+------------------------|
| Selon contexte : TSH, glycémie, créat, protéinurie, BU | Cholestérol                           |                        |
| Comorbidité                                            | - familiales :                        | CV, xanthomes          |
| - hypocholestérolémie : hypothyroïdie                  | + /récepteur LDL/                     |                        |
| - mixtes : sd néphrotique, grossesse                   | + apolipoprotéine B, PCSK9            |                        |
| - hyperTG : IR chronique, alcoolisme,                  | - polygéniques                        | pas d'hérédité         |
| (obésité, diabète + sd métabolique)                    | Mixtes                                |                        |
| Iatrogène : ciclosporine, corticoïdes                  | - /combinées familiales/++            | CV, _pas_ de xanthomes |
| oestrogènes oraux, rétinoïdes,                         | - dysbetalipoprotéinémie              | xanthomes              |
| IFN-\alpha, antétroviraux, neuroleptiques              | TG :                                  |                        |
| diurétiques thiazidiques, \beta{}bloquant              | - familiale                           | xanthomes              |
|                                                        | -  hyperlipidémie combinée familiable |                        |
...
Diététique
  - lipides < 40%, graisses saturées < 12%, plutôt mono- et polyinsaturées
...
Hypercholestérolémies : primaire si LDL élèvé à ttt+6 mois, secondaire si complication ischémique
 ...
 - hypertriglycéridémies : diététique \pm statines si TG > 2g/L (fibrates si échec)
