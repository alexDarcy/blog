...
| Étiologies        | bicuspidie < 65 ans                                                   |
|                   | dégénératif après (rarement post-rhumatismal)                         |
|-------------------+-----------------------------------------------------------------------|
| Complication      | acrshort:IC, acrshort:FA, troubles conduction, mort subite++          |
|-------------------+-----------------------------------------------------------------------|
| Clinique          | \hl Dyspnée d'effort, angor d'effort, syncope/ (d'effort ?)           |
| Auscultation      | {souffle mésosystolique éjectionnel, rude, râpeux} \pm abolition B2   |
|                   | Frémissement palpatoire (foyer aortique)                              |
|-------------------+-----------------------------------------------------------------------|
...
| *ETT*               | \hl - V max > 4m/s                                                    |
|                   | \hl - gradient moyen > 40 mmHg                                        |
|                   | \hl - surface aortique < 1 cm^2                                       |
|-------------------+-----------------------------------------------------------------------|
...
[fn:7] Pronostic vital mis en jeu si symptômes ! \skull
