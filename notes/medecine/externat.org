...
**** PEC
USIC \faBomb : ECG, dosage troponine, créatinine, glycémie, NFS
#+BEGIN_EXPORT latex 
\begin{itemize}
\item \hl{aspirine} + 
    $\begin{cases}
...
|             | Marfan  |                  | \Delta PAS > 20mmHg   | N ou SCA         | \inc médiastin | Chir \faBomb       |
|-------------+---------+------------------+-----------------------+------------------+----------------+-------------------|
...
*** Complications
  ...
  - Infectieuses
      ...
      - Endocardite infectieuses : \textbf{redoutable} \faBomb\\
...
Dans le faisceau de His ou infra : rythme très lent donc grave \faBomb
...
Diagnostic : préciser degré, paroxistique/permanent, siège++ 
  ...
  - nodaux : souvent BAV I, BAV II Wenckebach, BAV III à QRS fins \thus
   Holter
  - (infra)hissiens : sur des BdB ou BAV II Möbitz. \faBomb{} si complet DC
    possible !\\
...
*** Traitement
Bradycardie grave = urgence ! (rea) \faBomb
...
Trifasciculaire \faBomb : (alterne BdB droit et gauche) ou (BdB droit et
...
Toute tachycardie à QRS larges est une tachycardie ventriculaire
  \gls{JPDC} qui dégénere en fibrillation ventriculaire \faBomb
\end{tcolorbox}
...
Fibrillation ventriculaire : \textbf{urgence absolue}  \faBomb massage cardiaque
+ choc
...
Gravité ?
  ...
  - clinique : pouls > 150 /min, hypotension artérielle, angor, insuf
    cardiaque, neuro
  - ECG : tachy à QRS large = urgence absolue \faBomb\\
...
**** Médicaments si FE < 40%
  1. Diurétiques \footnote{congestion} + IEC \footnote{diminue angiotensine II} + betabloquants
    (\faBomb pas immédiatement si crise aigüe \danger{}) $\pm$ antagonistes des
...
Autres :
  ...
  - Urgence : éviter baisse brutale tension et hypotension \faBomb
...
|               | Tamponnade \faBomb                  | remplissage, ponction/drainage                 |
|               |                                    |                                                |
...
**** Paracétamol
 ...
 Tolérance :
 - si surdosage : 
   - hépatotoxique \thus urgence \faBomb \thus N-acétylcysténine
...
***** Diagnostic
 Si diagnostic *non* posé : cortisol + ATCH. Ne pas attendre les résultats \faBomb
...
- \faBomb : diabète + microangiopathie sévère, diabète + atteinte vasculaire
...
Autres
 - Ischémie/nécrose : peau froide, fine, dépilée, livedo. \thus revasculariser en urgence \faBomb
 - Nécrose + MPP
...
**** TTt
 - Aigüe = urgence \faBomb \thus calcium IV lente (2-3x10ml). Suspension des ttt qui \inc
...
***** Clinique
    ...
    |--------------------------------+-------------------------------------------------+----------------------------|
    | Intoxications alcoolique aigüe | alcoolémie, régression de qq heures             | coma alcoolique \faBomb     |
    ...
    | DT                             | brutal/petits signes de sevrage/crise comitiale | Sd confusionnel, DC \faBomb |
...
Contage + \inc transaminases (DD Table [[tab:transaminases]]) + sérologie/génome viral
 ...
 - chercher signes de gravité : TP < 50%, encéphalopathie \faBomb
...
\begin{tcolorbox}
Urgence = hépatite fulminante \faBomb : sd hémorragique + signes d'encéphalite
...
Hépatite chronique B : diag = Ag HBs positif > 6mois. 
 ...
 - 40% de mutation
 - Immunosuppresseurs = risque de réactivation \faBomb
...
|              | parasite                   |                     | colites       |                   |
 Ischémie intestinale aigüe = urgence avec pronostic vital \faBomb [fn:107]
...
- rupture de la paroi de l'\oe{}sophage : exceptionnel, urgence \faBomb [fn:126] \thus diag par TDM thoracique
...
- 3eme trimestre : urgence \faBomb si téatose aigüe gravidique, prééclampsie
...
*** Urgences
 ...
 - Insuffisance hépatique :
   ...
   - insuf. hépatique aigüe : 
     ...
     - risque = insuf hépatique grave : 80% mortalité \faBomb
...
***** Complications
- Infections du liquide d'ascite \faBomb : C3G proabiliste (car monomicrobe) + albumine 
...
\faBomb Urgence si sd septicémique/déshydratition sévère : ciprofloxacine 3-5j (puis
adapté), IV (eau, Na+, K+)
...
***** Complication
Hernie étranglée = urgence chir \faBomb : douleur brutale de l'aine,
...
- Compliquée : 
  ...
  - péritonite appendiculaire = urgence \faBomb ATB puis appendicectomie
...
\paragraph{Autres} : paludisme [urgence \faBomb (quinine-artésunate IV)], IU, \bact{burnetii}
...
\paragraph{Diphtérie} : rare mais urgence \faBomb
...
Nécrosante chez immunodéprimé + polype $\to$ avis ORL en urgence \faBomb
...
Urgence \faBomb : ponction articulaire, hémoculture puis ATB probabiliste
...
\danger Bactériéme + sepsis = urgence \faBomb
...
Fongémies (Candida) : souvent soin + terrain. Grave \faBomb.\\
  ...
  \item respiratoires
    \begin{itemize}
      \item surinfection bactérienne : OMA, sinusite aigüe, surtout pneumonie aigüe =
        grippe maligne primaire (rare, $\faBomb$) et secondaire
    \end{itemize}
...
Fièvre aigüe chez l'ID = urgence \faBomb
...
Fièvre + PNN \(< 500/mm^3\) urgence \faBomb
...
- DEP < 50%
- silence auscultatoire \faBomb
- respi paradoxale \faBomb
- troubles conscience, bradycardie, collapsus \faBomb
...
- respi abdo paradoxale \faBomb{} défaillance court terme
...
*** Examen
 ...
 - mode d'installation : urgence si brutal \faBomb
...
**** \OE{}il rouge, douloureux, BAV
 ...
 \ttt
     ...
     sans avoir éliminé une ulcération cornéenne \faBomb
 ...
 \ttt antalgique, inhibiteurs de l'anhydrase carbonique [fn:183]\faBomb, solutés hyperosmolaires[fn:184], collyre hypotonisants,
     collyres myotiques\\
...
**** BAV, \oe{}il blanc indolore
 ...
 - FO visible anormal
   ...
   - /neuropathie optique ischémique antérieure/ : BAV unilatérale brutale, \dec
     ...
     artériosclérose mais penser à Horton (urgence \faBomb)
 - FO visible normal
 ...
 Anomalies transitoire 
   - /cécité monoculaire transitoire/ (qq minute) = amarause. FO pour embole
     rétinien. Urgence \faBomb. Chercher athérome carotidien, cardiopathie embolinogène
...
*** Formes cliniques :
 ...
 - crise aigüe de fermeture de l'angle : douleur, urgence \faBomb
...
*** Occlusion de l'artère centrale de la rétine
 ...
 - thromboses : maladie de Horton (urgence \faBomb, à rechercher), (maladies de systèmes)
 ...
 CAT : urgence \danger \faBomb (fonction visuelle et patho sous-jacente)
...
** 20 \dagger Neuropathie optique ischémique antérieure
 ...
 Étiologie : 
 - maladie de Horton = urgence \faBomb (cécité bilatérale définitive) \thus 
...
FR = durée et intensité de l'hyperglycémie
 ...
 Cécité possible du jour au lendemain \faBomb
...
[fn:7] Pronostic vital mis en jeu si symptômes ! \faBomb
