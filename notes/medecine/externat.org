...
**** Examens
  ...
  - Coronarographie (parfois + ventriculographie) : sténose si > 70%
    lumière. Invasif, complications rare. /Si angor suspecté et examen d'ischémie positif/[fn:8]
...
**** Mauvais pronostic : 
  ...
  - plusieurs segments ischémique, fraction d'éjection < 40%[fn:cardio_1]
...
\end{tcolorbox}
  ...
  - 2 tableaux
      ...
      - c\oe{}ur pulmonaire aigü[fn:9] : dyspnée, défaillance ventriculaire
...
Para clinique
  ...
  - Radio thorax : normale si $\le$ modérée. cardiomégalie, dilatation OG,
    HTAP
  - /ETT/ référence (et ETO). Sévérité côtée en 4 grades[fn:10] (Vérifier la
    tricuspide)
...
** 150 \dagger - Surveillance des porteurs de valves, prothèses vasculaires
  ...
  - Biologiques : pas d'anticoagulant, chez > 65 ans (aortique) ou > 70
    (mitrale) [faible durée de vie[fn:cardio_2]].
...
Hémocultures négatives :
   ...
   - ATB
   - croissante lente : HACEK[fn:21], Brucella, champignons
...
***** SOPK (majorité)
 ...
 - 2 parmi : {hyperandrogénie clinique[fn:endocrino3], oligo-/a-novulation, hypertrophie
   ovarienne/folliculaire[fn:2] (écho)}
...
**** Démarche
  ...
  - Mesure de testostérone totale :
    ...
    - \in [2.3, 3.2] : doser SHBG[fn:3], calculer index de T libre, si bas, chercher cause
...
***** Dépistage [fn:hge1]
 Questionnaires : AUDIT-C, FACE. Biologie [fn:hge2] non utile.
***** Clinique
...
***** Complications somatiques[fn:22] 
...
\danger atypique fréquent, asymptomatique
 ...
 Diag = /endoscopie digestive haute/[fn:hge17] (perte de substance profonde, blanchâtre, ovalaire, bords réguliers)
...
- perforation ulcéreuse [fn:31] CI à l'endoscopie \danger
- sténose ulcéreuse (exceptionnelle) : évac stase, troubles hydroélectriques, IPP[fn:36] 
- gastrite aigüe - atropie / métaplasie - dysplasie - cancer invasif

***** Traitement UGD non compliqué
- \bact{helicobacter}
  - éradication : 10j avec IPP + amoxicilline + clarithromycine[fn:32] si
    sensible, sinon quadrithérapie[fn:33] 
...
***** Chronique de mécanisme immunitaire
 - Auto-immune : possible carence facteur intrinsèque[fn:38]/martiale,
...
**** Diverticulite compliquée [fn:24]
***** Forme classique
 ...
 Ttt : 
 - amoxicilline + acide clavulanique [fn:23](PO si ambulatoire, Iv si hospit)
...
***** Diagnostic
= symptômes[fn:25] + examen clinique seulement
- symptômes (si précoce[fn:26]): 
...
***** Ttt
Chirurgie : si crurales, inguinale chez l'enfant [fn:27] ou
...
***** Épidémiologie
3eme K le plus fréquent[fn:29], 2eme cause DC par K[fn:30]. 5% de la
...
** 108 \dagger - Troubles du sommeil
*** Définitions
...
- obstructive : arrêt débit \(\ge\) 10s + efforts ventilatoires
- centrale : idem, sans efforts ventilatoires
- mixte = obstructive et centrale
...
- neuropsy + accidents (risque x2)
- CV : HTA, insuf. coronaire, cardiaque, ACFA
- sd métabolique\footnote{Obésité abdo et (2 parmi : HTA, glycémie \(\ge\) 5.6 mmol/L,
...
- nocturne = ronflements, pause respi, étouffement, nycturie
- diurne = somnolence excessive (questionnaire d'Epworth)

DD : hypersomnie diurne (insomnie, sd dépressif, sédatif, hygiène de sommeil,
neuro)
**** Examen

- IMC, obésité abdo (\(\ge\) 94 cm \male, 80cm \female)
- ORL
- CV, respi
...
- Pression positive continue = 1ere intention
- Orthèse d'avancée mandibulaire = 2eme
- Autres : orthèse anti-décubitus dorsal, chirurgie = {vélo-amygdalienne,
  avancée maxillo-mandibulaire (lourd++), nasale}

*** Autres

- Sd d'apnée de type central : cause = {insuf. cardiaque sévère (traitement !),
    atteinte tronc cérébral, séjour altitude, morphiniques}
- Hypoventilation alvéolaire : aggravation de l'état de veille. Traitement =
  VNI\footnote{ventilation non invasive}
- Sd obésité hypoventilation : (PaCO\(_{\text{2}}\) > 45 mmHg) et (PaO\(_{\text{2}}\) < 70 mmFg) et
...
** 205 \dagger BPCO\footnote{Bronchopneumopathie chronique obstructive}
\label{sec:205-bpco}
...
Inclus dans BPCO *si TVO* : 

- bronchite chronique (toux productive quotidienne \(\ge 3\) mois/an et \(\ge 2\) ans),
...
- obstruction : GOLD (stade 1 (VEMS $\ge 80\%$) à 4 (VEMS < 30%))
- dyspnée : échelle MRC (0 (effort important) à 4 (habiller))
- fréquences exacerbations ($\ge 2$/an = grave)
...
- spirométrie : TVO (VEMS/CVF < 0.7) persistante après bronchodilateur
- pléthysmographie (identifie distension pulmonaire)
- $T_{LCO} < 70\%$ = pathologique
- si VEMS < 50% ou $SpO_2< 90$% : gaz du sang, test d'exercice
...
**** Stratégie
Score sPESI = \texttt{90 100 110 C C} [fn:4]:
...
*** Globe
 ...
 Annexes
 - oculomoteur : nerf IV = {oblique supérieur[fn:ophtalmo3]}, VI = {droit externe} et III =
...
*** Corps étrangers
 ...
 Complications tardives : ophtalmie sympathique [fn:ophtalmo22], sidérose (fer),
 chalcose (cuivre)
...
[fn:38] \thus anémie macrocytaire arégénérative, glossite, neuro

[fn:37] Génétique possible mais pas de stress, ni facteurs psycho

[fn:36] Dilatation voir chir si besoin

[fn:35] Après avoir éliminé Zollinger-Ellison, Crohn, lymphome, K gastrique

[fn:34] Si échec, quadrithérapie /ATBgramme. Si échec : IPP long cours

[fn:33] Métronidazole, tétracycline, sous-citrate de bismuth et oméprazole

[fn:32] Ou lévoflaxicine

[fn:31] Plutôt en péritoine libre : douleur épigastrique en "coup de
   poignard", choc, contracture épig. puis généralisée, cul-de-sac de Douglas
   douloureux au TR, pneumopéritoine au scanner. 

[fn:30] Après poumon.

[fn:29] Après sein et prostate.

[fn:28] > 10 polypes

[fn:27] > 6 mois

[fn:26] Au bout de quelques années : douleurs quotidiennes, saignement abondant, procidence permanent

[fn:25] Non proportionnels à la gravité ! 

[fn:24] Ne rien faire si non compliquée !

[fn:23] Ou, si hospit, C3G (céfotaxime) + nitro-imidazolé 

[fn:22]  5 arguments pour rapporter une pathologie à l'alcool : consommation à risque,
  complication connue, tableau évocateur, pas d'autre cause, s'améliore avec le sevrage/réduction

[fn:21] Haemophilus, Actinobacillus,
...
[fn:10] Selon la Surface de l'orifice régurgitant, Volume régurgité

[fn:9] Insuffisance ventricule D suite à une augmentation brutale de sa post-charge

[fn:8] Examens complémentaires : test Méthergin pour forcer un spasme, FFR (fraction flow reserve) pour vérifier sténose

[fn:7] Classes de 1 à 4
...
[fn:cardio_2] 40% durent 15 ans

[fn:cardio_1] Normale si > 55%

[fn:4] Sat < 90%, PAS < 100 mmHg, FC > 110/min, Cancer, insuf Cardiaque chronique

[fn:3] Se fixe à la testostérone, estradiol

[fn:2] V > 10mL, \ge 19 follicule par ovaires

[fn:ophtalmo3] S'attache côté médial
...
[fn:hge2] Alcoolémie, \gamma-GT, VGM, transferrine désialylée

[fn:hge1] 20-30% adultes en CS ont un problème avec l'alcool
