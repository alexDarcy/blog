...
\newacronym{PAPO}{PAPO}{Pression artérielle pulmonaire d'occlusion, $\approx$ pression
oreillette G} 
...
\begin{figure}[htpb]
  ...
  \resizebox{0.6\linewidth}{!}{
    ...
    tree layout]
    {
      ...
      ddimere -> {                                                                   
        contention [>"$> 500\mu$g/L"] -> "écho-doppler veineux" -> {                 
...
provoquée
\item Recherche de thrombophilie si (1er épisode (non provoqué < 60 ans) ou
  femme âge procrééer)) ou (récidive (MTEV proximale) \lor (TVP distale non
  provoquée)
