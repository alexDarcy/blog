...
|              | trinitro-sensible   |                        |                                       |
| SCA sans ST  | angineuse           | \faHospitalO{} urgente | Aspirine, inhib P2Y12                 |
...
Complications : embolie, thromboses[fn:6], désinsertion, EI \faBomb,
...
- \faBomb{} exacerbation grave : SAMU + \beta_2-mimétique \rightarrow \faHospitalO : \beta_2-mimétique nébulisé, corticoïdes
  oraux, $O_2$
Rhinite : 
...
\faBomb Urgence (atteinte multiviscérale menaçant la vie) : adrénaline _IM_
...
- spécifique : 
  ...
  - Crise aigüe thyrotoxique \faBomb ATS, pronanolol, corticoïdes puis iode
...
- ttt : aigü \faBomb calcium IV lente. Chronique : vitamine D et calcium
...
- Étiologie : embolies (athémore carotidien), maladie de horton = urgence \faBomb
- CAT = urgence \faBomb. Très mauvais pronostic fonctionnel
...
- maladie de Horton = urgence \faBomb. Bio = VS \inc, CRP \inc \thus
