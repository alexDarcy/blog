...
%\input ue1-4-securite
%\input ue2-26-prevention-risques-foetaux
%\input ue6-143-vaccination
%\input ue6-144-fievre-aigue
%\input ue6-145-infections-naso-sinus
%\input ue6-146-angine
%\input ue6-147-otites
%\input ue6-148-meningite
%\input ue6-149-endocardite
%\input ue6-150-porteur
%\input ue6-151-infection-pulmonaire
%\input ue6-156-tetanos
%\input ue6-157-infection-urinaire
%\input ue6-158-ist
%\input ue6-159-coqueluche
%\input ue6-160-exantheme
%\input ue6-161-oreillons
%\input ue6-162-grippe
%\input ue6-164-herpes
%\input ue6-165-vih
%\input ue6-166-paludisme
%\input ue6-169-zoonose
%\input ue6-173-atb
%\input ue6-174-risques
%\input ue7-213-sd-mononucleosique
%\input ue7-216-adenopathies
...
\begin{table}[htpb]
  ...
  \begin{tabular}{*{4}{c}}
    ...
    \midrule
    Toxoplasmose & 10 SA & Hygiène & Spiramycine ou Pyriméthmaine\\
...
aténué (fièvre jaune si voyage obligatoire)
...
\tightlist
\item
  \(\ge 38^{o}\) le matin, \(38.3^{o}\) le soir
\item
  aigüe si \textless{} 5 jours
\item
  prolongée si \textgreater{} 20 jours
\end{itemize}
...
\begin{itemize}
\item
  neuro: angoisse, agitation, confuion, troubles du comportement, coma
\item
...
Traitement ATB : seulement pour SGA, l'angine de Vincent, diphtérie, gonocoque,
...
Étiologie = EBV, VIH (virus) ou streptocoque $\beta$-hémolytique du groupe A
(SGA)
...
Oedème de la trompe d'Eustache -> otite congestive -> otite purulente
...
Nécrosante chez immunodéprimé + polype -> avis ORL en urgence \skull
...
l'enfant. Chez l'adule, chercher tumeur du cavum.

Diagnostic : hypoacousie, tympans mats

Guéris spontanée, pas d'ATB.

\subsection{Otites cholestatomateuse}%
...
\begin{table}[htpb]
  ...
  \begin{tabular}{*{4}{c}}
    ...
    Gram+ & Sd méningé franc  & 10-14j & Chercher porte d'entrée  \\
...
\tightlist
\item
  efficacité : fièvre, signes neuro
\item
  si évolution négative 48-\%\%72h : imagerie médicale puis PL de
  contrôle si pas de CI
\item
  suivi prolongé neuropsycho + audiométrique
\end{itemize}
...
\item
  50\% inconnues
\item
  virus : HSV, entérovirus, VIH
\item
  bactéries : M. tuberculosis, L. monocytogenes, Lyme, syphilis
\end{itemize}

À évoquer devant : fièvre, sd méningé, signes neuro centraux Traitement
:~aciclovir si encéphalite + méningite lymphocytaire normoglycorachique
{}
...
\item
  fivère
\item
  installation sur qq jours
\item
  Localisation temporale -\textgreater{} troubles du comportement,
...
post-chirurgical Polymicrobien :~streptocoques (oraux, mileri),
anaérobies
...
\begin{table}[htpb]
  ...
  \begin{tabular}{cc}
    ...
    \midrule
    Staphylococcus aureus & Cutanée\\
    Streptocoques oraux & Bucco-dentaire\\
    Streptococcus gallolyticus & Digestive\\
...
\danger Fièvre inexpliquée chez valvulopathie = EI par défaut

\danger Signe neuro. fébrile -\textgreater{} chercher EI (ascult + hémoc.)
...
\section{UE 6 - 150 : Surveillance des porteurs de valve et prothèses vasculaires}
...
\tightlist
\item
  signes fonctionnels respiratoires (toux, expector, dyspnée, douleur
  thoracique)
\item
  fébrile
\item
  radio (atteinte parenchyme) -\textgreater{} pneumonie
  ...
  \caption[dummy]{Prise en charge.  \\NB: 
    \begin{itemize}
      ...
      \item pneumonie franche lobaire aigüe : début brutal, douleur thoracique
        ``coup de poignard'', touche sèche -\textgreater{} expector.
...
\tightlist
\item
  respiratoire : plèver, parenchyme, voies aériennes, fonctionnelle
\item
  générales : décompensation, complication infectieuses à distance, choc
  septique, décès
\end{itemize}

\subsection{Exacerbation de bronchopneumopathie obstructive}
...
\(\emptyset\) dyspnée\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
VEMS \textgreater{} 50\%\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
\(\emptyset\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.46\columnwidth}\raggedright
Dyspnée d'effort\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
VEMS \textless{} 50\%\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
Si expectoration purulente verdâtre : Amoxicilline\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.46\columnwidth}\raggedright
Dyspnée de repos\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
VEMS \textless{} 30\%\strut
\end{minipage} & \begin{minipage}[t]{0.23\columnwidth}\raggedright
Amoxicilline/acide clavulanique\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
layered layout]
{
  ...
  Pneumocoque[draw] // [layered layout] {
    "\faHospitalSign Examen direct/Ag" -> Amoxicilline;
    "\faAmbulance ?" -> Amoxicilline;
  } -> "Réévaluation 48-72h";
  Legionella[draw] // [layered layout] {
    "\faHospitalSign Ag Legionella" -> Macrolide;
    "\faAmbulance Intracellulaire ?" -> Macrolide;
  } 
  -> "Réévaluation 48-72h" -> {
    "\faAmbulance" [level distance=2cm] -> ["échec"] Échange;
    "\faHospitalSign" ;
    "\faHospitalSign" -> ["échec"] "Amoxicilline + macrolide\\(+ acide clavulanique\\si agé/comorbid)";
    "\faHospitalSign" -> ["non"] "Amoxicilline\\(+ acide clavulanique\\si agé/comorbid)";
  }
};
\end{figure}
...
\section{UE 6 - 152 : Infections cutanéo-muqueuses}%
...
Complications : 
\begin{itemize}
  \item locale = staphylococcie maligne de la face \danger urgence \faHospitalSign{}.
...
candidosiques\\
Candida ou dermatophyte -> azolés local ou grséofulvine (teignes)
...
\begin{itemize}
  ...
  \item chroniques : argumenter diagnostic, isoler agent
    \item arthrite septique/bactériémie/sepsis grave/choc septique : ATB
      probabiliste $\beta$-lactamine $\pm$ gentamicine $\pm$ glycopetitde
\end{itemize}
...
\subsection{Infection du pied diabituqe}
Plaie infectée chez diabètique -> avis spécialisé\\
Ostéite : contact osseux + infection = bonne VPP\\
Souvent polymicrobien (\bact{dore})\\
ATB adaptée (2 semaines)


\section{UE 6 - 154 : Bactériémie, fongémie}%
...
\begin{itemize}
  ...
  \item CG- : cefotaxime/ceftriaxonie (méningocoque)
  \item BG+ : amoxicilline (Listera)
  \item BG- : cefotaxime/ceftriaxonie (+ imidazolé si voie dig/bilaire ou pas de
    foyer)
\end{itemize}
...
Patgnomonique : granulome épithélioïde giganto-cellulaire centré par de la
nécrose caséeuse\\
...
\begin{table}[htpb]
  ...
  \begin{tabular}{*{6}{c}}
    \toprule
  & < 5 ans & < 79 ans & $\ge 80$ ans & Migran < 15 ans & Migrant $\ge$ 15 ans \\
  \midrule
  IDR         & X & X &   &   & X \\
  IFN$\gamma$ &   & X & X & X & X \\
  \bottomrule
...
Clinique : fièvre prolongée, sueurs nocturnes, SDRA, neuro-méningés,
péricardite.\\
Riado thorax, culture (hémoculture, LCS, biopsie)
...
\begin{itemize}
  ...
  \item péricardite : rare en France. Clinique = fièvre, douleurs thoracique,
    dyspnée. Anomalies CG, radio thorax, écho cardiaque, culture liquie
    péricardique
  \item neuro-méningé : AEG, progressif, sd méningé, rhombencéphalite, déficits
    focaux. PL (lymphocytair, hyperprot, hypoglyco), aranchoidite de la base
    (IRM), culture LCS
  \item urinaire : leucocyturie aseptique. Urine 3j
  \item génitale : Clinique = \male{} prostatie, épididymite, masse scrotale. \female{}
    trouble mestruels, douleur abdomino-pelvienne. \male{} calcifications.
    \female{} culture sur menstruations/frottis
  \item digestive : firbo, colonoscopie
  \item laryngé : rare. Clinique = ulcération douloureuse, toux, dysphagie,
    odynophagie, wheeing. Prélèvement local
\end{itemize}

\subsection{Traitement}%
\label{sub:traitement}

ITL : ttt si immunodérimé, infection < 2 an, enfant < 15 ans
Primo-infectio : oui si symptomatique, sinon au cas par cas

EI : 
\begin{itemize}
  \item rifampicine : cytolyse hépatique, urines orange
  \item isoniazide : cytolyse hépatique, neuropatie périph
  \item pyrazinamide : hépatitte toxique
  \item éthambutal : névrite optique
\end{itemize}
...
\endhead
\begin{minipage}[t]{0.24\columnwidth}\raggedright
Mineure, propre\strut
\end{minipage} & \begin{minipage}[t]{0.38\columnwidth}\raggedright
∅ injection\strut
\end{minipage} & \begin{minipage}[t]{0.29\columnwidth}\raggedright
Vaccin immédiat\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.24\columnwidth}\raggedright
Majeure/contamination tellurique possible\strut
\end{minipage} & \begin{minipage}[t]{0.38\columnwidth}\raggedright
pas d'injection\strut
\end{minipage} & \begin{minipage}[t]{0.29\columnwidth}\raggedright
Ig 250 UI dans 1 bras, vaccin dans l'autre\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
Diagnostic : BU
\textit{Diagnostic différentiel}  : pyélonéphrite (fièvre, frissons, douleurs
abdo/lombaire)
...
\begin{figure}[htpb]
  ...
  layered layout]
  {
    ...
    C3G parentérales -> "ATB adaptée (10-14j)" [draw];
  };
  \caption{Traitement de la PNA à risque}
\end{figure}
...
\subsection{IU masculine/prostatie aigüe}%
\label{sub:iu_masculine_prostatie_aigue}

Clinique : 
\begin{itemize}
  \item fièvre élegée, sueurs, frissons
...
\begin{itemize}
  ...
  \item \male{} urétrite, orchite, prostatie
...
\item
  clinique : rash maculopapuleux (joue -\textgreater{} tronc
  -\textgreater{} extrémités), arthralgies
\item
...
\item
  ...
  \begin{itemize}
  \item
    fièvre prolongée, exanthème, glossie
  \item
...
\begin{itemize}
\item
  très contagieuse (J-2 à J+5), incubation 14 jours
\item
  clinique : phase d'état

  \begin{itemize}
  \item
    macule-papule prurigineuses vésicules (gouttes de rosée)
    -\textgreater{} croûte
  \item
    respecte paume des mains, plantes des pieds
  \end{itemize}
\item
  complication : surinfection (strepto A), immunodéprimé, néonatale,
  congénitale
\item
  traitement : symptomatique, antiviral si immunodéprimé, prévention
\end{itemize}
...
\item
  invasion 24-48h
\item
  état : parotidite ourliennes (70\%) unilatérale puis bilatérale
\end{itemize}
...
\section{UE 6 - 164 : Infections à herpès virus du sujet immunocompétent}
\label{sec:item164}
...
\toprule
Type & VCA IgG & VCA IgM & EBNA IgG\tabularnewline
\midrule
\endhead
Séronégatif & - & - & -\tabularnewline
Séropositif & + & - & -\tabularnewline
Primo-infection & +/- & + & -\tabularnewline
\bottomrule
\end{longtable}
...
Traitement :\\
- gingivostomatite aigüe : spontanément favorable - ophtalmologique
:~aciclovir pommade (+ IV ?), pas de corticothérapie ⚠ - préventif si
\textgreater{} 6 récurrences/an (valaciclovir quotidien 6-12 mois)
...
\item
  incubation (14j)
\item
  état : (maculo-papule) -\textgreater{} vésicules (prurit+++)
  -\textgreater{}\_érosion + pseudo-ombilication -\textgreater{} croûtes
  (J4) -\textgreater{} cicatrisation (J10)
\item
...
\tightlist
\item
  surinfection bactérienne fréquente (grattage)
\item
  terrains, état infectieux sévère, respiratoie neuro, purpura
  thrombopénique aigu
\end{itemize}
...
\tightlist
\item
  symptomatique (pas d'aspirine, ni AINS ⚠)
\item
  ATB si surinfection cutanée, antiviral si formes graves/compliquées
\item
  pas d'éviction scolaire
\item
  vaccination : ado, \female en âge de procréer, contact avec ID, professionnel.
...
\item
  prodrome
\item
  état :~éruption (érythémateux roses vifs -\textgreater{} vésicules en
  bouquets -\textgreater{} érosives -\textgreater{} croûtes
  -\textgreater{} cicatrices dépigmentées (rosées -\textgreater{}
  blanchâtres) + fébricule
\item
  poussées sur 2-3 semaines, douleurs plusieurs mois
\end{itemize}
...
\tightlist
\item
  local : symptomatique, douleur (antalgique phase aigüe)
\item
  ATB si surinfection cutanée, antiviral en prévention DPZ (valaciclovir
  per os 7 jours)
\item
  prévention vaccination (entre 65 et 74 ans)
\end{itemize}

\subsection{Complications}

HSV1, 2 : - nouveau-né (périnatale++) :~mortalité très élevée, séquelle
très lourdes - femme enceinte : maladie chez nouveau-né - atopique :
Kaposi-Juliusberg VZV

\section{UE 6 - 165 : VIH}

Transmission : sexuel, sang, mère -\textgreater{} enfant Prévention
...
Infection non-opportuniste\strut
...
Pneumonie à S. pneumonia\strut
\end{minipage} & \begin{minipage}[t]{0.56\columnwidth}\raggedright
Vaccin\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.38\columnwidth}\raggedright
Infections digestions\strut
\end{minipage} & \begin{minipage}[t]{0.56\columnwidth}\raggedright
Hygiène alimentaire\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.38\columnwidth}\raggedright
Grippe\strut
\end{minipage} & \begin{minipage}[t]{0.56\columnwidth}\raggedright
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.38\columnwidth}\raggedright
IST (syphilis, gonococcies, C. trachomatis, HPV)\strut
\end{minipage} & \begin{minipage}[t]{0.56\columnwidth}\raggedright
Préservatif, dépistage, vaccin VHA, VHB (homosexuel hommes)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.38\columnwidth}\raggedright
VHB, VHC\strut
\end{minipage} & \begin{minipage}[t]{0.56\columnwidth}\raggedright
Surveillance, vaccination\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
Bacille de Koch, examen anatomopathologique\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
ITL par IGRA\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.20\columnwidth}\raggedright
Candidose oesophagienne 🔥\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\textless{} 200\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
Clinique\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.20\columnwidth}\raggedright
Pneumocystose pulmonaire 🔥\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\textless{} 200\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
Radio thorax (interstitiel), prélèvements respi\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
Cotrimoxazole si CD4 \textless{} 200\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.20\columnwidth}\raggedright
Toxoplasmose cérébrale 🔥\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\textless{} 200\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
TDM/IRM -\textgreater{} sérologie -\textgreater{} PCR LCS
-\textgreater{} test thérapeutique -\textgreater{} biopsie\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
Cotrimoxazole si CD4 \textless{} 100\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.20\columnwidth}\raggedright
CMV 🔥\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.20\columnwidth}\raggedright
Mycobactérioses atypiques\strut
\end{minipage} & \begin{minipage}[t]{0.30\columnwidth}\raggedright
\textless{} 100\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
Hémocultures, prélèvement\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright
\strut
\end{minipage}\tabularnewline
\bottomrule
...
layered layout]
{
  ...
  +/- Ag circulants" [draw] -> {
    ...
    "P. falciparum\\/knowlesi" -> {
      "Signes de gravité ?" [level distance=40pt] -> ["oui"] "\faHospitalSign{} urgence\\artésunate IV" [draw];
...
Défaillance neuro\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Défaillance respi\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
Ventilé:~\(PaO_2/FiO_2 < 300\) mmHg. Non ventilé : \(PaO_2 < 60\) mmHg
ou \(SpO_2 < 92\) \% ou FR \textgreater{} 30/min. Radio (interstitelle,
alvéolaire)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Défaillance CV\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
PA systol. \textless{} 80 mmHg + signes insuffisance circulatoire\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Hémorragie\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
...
Ictère\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
clinique / bilirubine \(> 50 \mu{}mol/L\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Hémoglobuinurie macroscopique\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Anémie\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
Hg \textless{} 5 g/dL, Ht \textless{} 20\%\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Hyoglycémie\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
glycémie \textless{} 2.2 mmol/L\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Acidose\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
bicarbonates plasma. \textless{} 15 mmol/L ou ph \textless{} 7.35\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Hyperlactémie\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
\textgreater{} 2 mmol/L\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Hyperparasitémie\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
\textgreater{} 4\%\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.34\columnwidth}\raggedright
Insuffisance rénale\strut
\end{minipage} & \begin{minipage}[t]{0.60\columnwidth}\raggedright
créat. \(> 65 \mu{}mol/L\) ou urée sanguine \textgreater{} 20
mmol/L\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\subsection{Toxoplasmose}%
\label{sub:toxoplasmose}

Diagnostic : infection aigue + sérologie 

Immuno-compétent : Pas de traitement
Immunodéprimé : pyrimethamine + acide folinique + sulfadiazine
...
Clinique : locorégionale + au moins une adénobathie. 2-3 semaines incuabtion
...
\subsection{UE 6 - Item 171 : Voyage en pays tropical}%
\subsection{Vaccins}%
...
\section{Syndrome mononucléosique}%
...
\section{Adénopathies superficielles}%
