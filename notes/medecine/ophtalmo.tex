...
\label{sec:orgf4cc128}
\subsection{Globe}
\label{sec:orgd3a4c10}
...
\label{sec:orge13847d}
\subsection{Examen}
\label{sec:orga223fb4}
...
\label{sec:org03c9182}
\subsection{Examen}
\label{sec:orgadc9f3b}
...
\label{sec:orge30b8b0}
\subsection{Diagnostic}
\label{sec:orgbeb7c17}
...
\label{sec:orgcfd90b2}
\subsection{Globe fermé (contusions)}
\label{sec:org2d5beff}
...
1mg/kg/j
\item non artéritique : pasd de ttt efficace
\end{itemize}
\end{document}
