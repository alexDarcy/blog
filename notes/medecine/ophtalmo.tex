...
\label{sec:orgd69c7d0}
\subsection{Globe}
\label{sec:orged375bf}
...
\label{sec:orgdf7b708}
\subsection{Examen}
\label{sec:org28c2010}
...
\label{sec:org1edc6be}
\subsection{Examen}
\label{sec:org12149f9}
...
\label{sec:org195aad8}
\subsection{Diagnostic}
\label{sec:org7fa67d0}
...
\label{sec:orgfd1aaa0}
\subsection{Globe fermé (contusions)}
\label{sec:orga105c50}
...
métamorphopsies
\item AV (oeil par oeil, bionculaire)
\item lampe à fente : 
\begin{itemize}
