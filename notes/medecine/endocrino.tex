...
\label{sec:org8ecda58}
\subsection{Contraception hormonale}
\label{sec:org66f54a6}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orge3c8750}
\subsubsection{Primaire}
\label{sec:orgbe5984f}
...
\label{sec:org1ebef43}
\begin{enumerate}
\item SOPK (majorité)
\label{sec:org95c72fe}
...
\label{sec:orgfcecc98}
\begin{enumerate}
\item Congénitales :
\label{sec:org5d7fe37}
...
\item Secondaires :
\label{sec:org1e96eee}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\end{enumerate}
\section{47 : Puberté}
\label{sec:orgc0b6742}
\subsection{Normale}
\label{sec:org19281ee}
...
\label{sec:org6928b24}
\subsection{Enfant}
\label{sec:orgd7c6ff5}
...
\label{sec:orgeae6e70}
\begin{table}[htbp]
\caption{Retard poid}
\centering
\begin{tabular}{ll}
\toprule
maladie coeliuaque & IgA \{totales, transglutamase\}, fibro\\
