...
\label{sec:org420971d}
\subsection{Contraception hormonale}
\label{sec:orgab5f6e8}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org2b069d2}
\subsubsection{Primaire}
\label{sec:org14f621d}
...
\label{sec:orgd033b23}
\begin{enumerate}
\item SOPK (majorité)
\label{sec:org774a18f}
...
\label{sec:orgffc8fd1}
\begin{enumerate}
\item Congénitales :
\label{sec:org1b10642}
...
\item Secondaires :
\label{sec:org5233bc5}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\end{enumerate}
\section{47 : Puberté}
\label{sec:org6b85146}
\subsection{Normale}
\label{sec:org40c708b}
...
\label{sec:org85eb60e}
\subsection{Enfant}
\label{sec:org0c449e6}
...
\label{sec:orga119235}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org9c3d4a2}
...
\label{sec:orgaba9613}
\subsubsection{Interrogatoire}
\label{sec:org7fdbc95}
\begin{itemize}
...
\label{sec:org3871fc0}
\subsubsection{Androgènes circulants}
\label{sec:orgf83e8c8}
