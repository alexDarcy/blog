...
\label{sec:org37bbb9f}
\subsection{Contraception hormonale}
\label{sec:orgf497c76}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org856bac8}
\subsubsection{Primaire}
\label{sec:org5a91d13}
...
\label{sec:org0b939c7}
\begin{enumerate}
\item SOPK (majorité)
\label{sec:orgd5adc2d}
...
\label{sec:orge78bb3a}
\begin{enumerate}
\item Congénitales :
\label{sec:org7d073c3}
...
\item Secondaires :
\label{sec:org33a6f10}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\end{enumerate}
\section{47 : Puberté}
\label{sec:org98490d4}
\subsection{Normale}
\label{sec:orge5bfd56}
...
\label{sec:org8a0deda}
\subsection{Enfant}
\label{sec:org420b779}
...
\label{sec:orga128ec7}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org9704576}
...
\label{sec:org7a59f68}
\subsubsection{Interrogatoire}
\label{sec:org585c309}
\begin{itemize}
...
\label{sec:org3ec95f4}
\subsubsection{Androgènes circulants}
\label{sec:orgfed2ff1}
...
\label{sec:org1f26dee}
À partir du stade 2

\subsubsection{Saignées}
\label{sec:org22f91fa}
