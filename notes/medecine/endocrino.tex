...
\label{sec:orge6bee18}
\subsection{Contraception hormonale}
\label{sec:orgbf14e4d}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org1501a9c}
\subsubsection{Primaire}
\label{sec:orge29b494}
...
\label{sec:orgc305768}
\paragraph{SOPK (majorité)}
\label{sec:org841a62a}
...
\label{sec:org45fba62}
\paragraph{Congénitales}
\label{sec:org657c2b8}
...
\label{sec:orgd36649a}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org5f6c110}
\subsection{Normale}
\label{sec:orgf45bb09}
...
\label{sec:orgd29000a}
\subsection{Enfant}
\label{sec:orgc24feb8}
...
\label{sec:orgb5569e7}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:org25c3227}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:org7157de4}. Précisions :
\begin{itemize}
...
\label{sec:org597db20}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orge8ba1d4}
...
\label{sec:orgf7f6ecc}
\subsubsection{Interrogatoire}
\label{sec:org5b6dee0}
\begin{itemize}
...
\label{sec:org2d1fec2}
\subsubsection{Androgènes circulants}
\label{sec:org0148003}
...
\label{sec:org5db4dbb}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org7dd88f7}
...
\label{sec:org39b8cd3}
\subsubsection{Auto-immunes}
\label{sec:org8d776c5}
...
\subsection{Étiologies}
\label{sec:orgb708de5}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org66f2746}
Auto-immunes :
\begin{itemize}
...
\label{sec:org28d0a14}
\subsection{Sd tumoral}
\label{sec:orgebe7723}
Clinique : 
\begin{itemize}
...
\label{sec:org0e74349}
\subsection{Insuffisance surrénale lente}
\label{sec:org71fcd6c}
...
\label{sec:org5de6116}
\subsubsection{Y penser}
\label{sec:org3f6699c}
\begin{itemize}
...
\label{sec:orgc1365d8}
\paragraph{Déf}
\label{sec:org5663841}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org08716a7}}, proprioceptiques\textsuperscript{\ref{org08716a7}}
\begin{itemize}
...
\label{sec:org7fb8a51}
Fréquent

\subsection{Interrogatoire}
\label{sec:org9d5a146}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org60262b8}
\subsection{Adulte}
\label{sec:orgdec69b5}
...
\label{sec:org4d931d5}
\subsection{Examen d'aptitude}
\label{sec:org8dbfbf9}
...
\label{sec:org31e1b7e}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgc9a02be}
...
\label{sec:org02d7413}
\subsection{Sécrétant des oestrogènes}
\label{sec:org7db1c20}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[61]{\label{org1accf86}Oestro-gastro-duodénaux}
...
\section{Annexes}
\label{sec:org8f1cb12}
\subsection{Hormones}
\label{sec:org62dfc2b}
...
\begin{figure}[htpb]
  ...
  \resizebox{!}{5cm}{
    ...
    tree layout]
    {
      ht/hypothalamus -> ["CRH"] hh/hypophyse -> ["ACTH"] cs/corticosurrénale -> cort/cortisol;
