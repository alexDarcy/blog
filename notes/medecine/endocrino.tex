...
Imagerie en urgence \danger : adénome en nécrose/hémorragie \faBomb
\end{itemize}
...
\danger ne pas attendre résultats pour commencer traitment \faBomb
...
si secondaire). 
Ne pas attendre les résultats \faBomb
...
cécité possible du jour au lendemain \faBomb \thus dépistage tous les 2 ans
...
revasculariser en urgence \faBomb
\item Combinaison nécrose et MPP
\item Dermo-hypodermite nécrosante : très rare, urgence vitale \faBomb. \{Teinte gris,
...
\danger Hypercalcémie = urgence \faBomb{} : 
\begin{itemize}
\item sérum phy
