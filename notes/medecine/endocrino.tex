...
\label{sec:orga275e75}
\subsection{Contraception hormonale}
\label{sec:org34be8c1}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgbd159ec}
\subsubsection{Primaire}
\label{sec:org88a1d3e}
...
\label{sec:org7359a1a}
\paragraph{SOPK (majorité)}
\label{sec:org1a6899f}
...
\label{sec:org74fe1da}
\paragraph{Congénitales}
\label{sec:org9ef41ee}
...
\label{sec:org674feb2}
\subsection{Enfant}
\label{sec:org556ee5f}
...
\label{sec:org5313faf}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orgba58117}
...
\label{sec:org6f5bb74}
\subsubsection{Auto-immunes}
\label{sec:org1472f22}
\paragraph{Maladie de Basedow}
\label{sec:orgb7e3e32}
...
\subsection{Étiologies}
\label{sec:org9770aa6}
\subsubsection{Hypothyroïdie primaire}
\label{sec:orga41e643}
Auto-immunes :
\begin{itemize}
...
\label{sec:orgeaf1049}
\subsection{Sd tumoral}
\label{sec:orgf560edf}
Clinique : 
\begin{itemize}
...
\label{sec:orga1e2102}
\subsubsection{Hyperprolactinémie}
\label{sec:org7a96d06}
...
\label{sec:orga39642e}
\subsection{Insuffisance surrénale lente}
\label{sec:orgb2952e0}
...
\label{sec:org3234bef}
\subsubsection{Y penser}
\label{sec:org057b6db}
\begin{itemize}
...
\label{sec:orgf3b07c9}
\paragraph{Déf}
\label{sec:org14e2b85}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{orga9551ec}}, proprioceptiques\textsuperscript{\ref{orga9551ec}}
\begin{itemize}
...
\label{sec:org293aba3}
Fréquent

\subsection{Interrogatoire}
\label{sec:org2a493d3}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org34b8c32}
\subsection{Adulte}
\label{sec:org31dd4f4}
...
\label{sec:orge77927e}
\subsection{Examen d'aptitude}
\label{sec:orgbf5cb69}
...
\label{sec:org378609b}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgb834583}
...
\label{sec:orgf847ce3}
\subsection{Sécrétant des oestrogènes}
\label{sec:orgb5cff68}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[56]{\label{org82a103b}Oestro-gastro-duodénaux}
