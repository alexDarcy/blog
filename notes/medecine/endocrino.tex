...
\label{sec:org6ff2aef}
\subsection{Contraception hormonale}
\label{sec:orgcf6c034}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org1220d4c}
\subsubsection{Primaire}
\label{sec:orgb858496}
...
\label{sec:org885fdfc}
\paragraph{SOPK (majorité)}
\label{sec:org6561f1e}
...
\label{sec:org5f04d52}
\paragraph{Congénitales}
\label{sec:orgf14abe6}
...
\label{sec:org33cc4d4}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org092e935}
\subsection{Normale}
\label{sec:orgf8ed725}
...
\label{sec:org1b82403}
\subsection{Enfant}
\label{sec:org8e4cc28}
...
\label{sec:orgb7dcb1f}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:org88f2a46}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:orgbceb276}. Précisions :
\begin{itemize}
...
\label{sec:org02a526d}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org83c6a81}
...
\label{sec:org7a43d21}
\subsubsection{Interrogatoire}
\label{sec:org6919e75}
\begin{itemize}
...
\label{sec:org6bdbab2}
\subsubsection{Androgènes circulants}
\label{sec:org86d42db}
...
\label{sec:org26244e0}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:orgce8f5e3}
...
\label{sec:org100f90e}
\subsubsection{Auto-immunes}
\label{sec:org74b6e89}
...
\subsection{Étiologies}
\label{sec:orgbe38bc4}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org89f9e29}
Auto-immunes :
\begin{itemize}
...
\label{sec:org77dc422}
\subsection{Sd tumoral}
\label{sec:org43f8bf3}
Clinique : 
\begin{itemize}
...
\label{sec:org3670d9d}
\subsection{Insuffisance surrénale lente}
\label{sec:org09dd621}
...
\label{sec:orgb7bd59d}
\subsubsection{Y penser}
\label{sec:orgeefa7c0}
\begin{itemize}
...
\label{sec:org86eafbd}
\paragraph{Déf}
\label{sec:orga5453a7}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org7e7207f}}, proprioceptiques\textsuperscript{\ref{org7e7207f}}
\begin{itemize}
...
\label{sec:orgb02f562}
Fréquent

\subsection{Interrogatoire}
\label{sec:org6f76bfc}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org0bf7c06}
\subsection{Adulte}
\label{sec:orgda9a5bb}
...
\label{sec:org4ddfa6c}
\subsection{Examen d'aptitude}
\label{sec:orge0b8b81}
...
\label{sec:org6c526f9}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:org477f41f}
...
\label{sec:org4aa6cd0}
\subsection{Sécrétant des oestrogènes}
\label{sec:org4cb21b3}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[63]{\label{org9e7b6bf}Oestro-gastro-duodénaux}
...
\section{Annexes}
\label{sec:org53cd26b}
\subsection{Hormones}
\label{sec:org49c1e80}
