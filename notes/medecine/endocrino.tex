...
\label{sec:org37a6512}
\subsection{Contraception hormonale}
\label{sec:orgc9fc567}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgcbe7efe}
\subsubsection{Primaire}
\label{sec:org3ca1787}
...
\label{sec:org649e7c3}
\paragraph{SOPK (majorité)}
\label{sec:orgc757d79}
...
\label{sec:orgc96c93a}
\paragraph{Congénitales :}
\label{sec:org6e902bb}
...
\label{sec:orge5bf303}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org9e383a5}
\subsection{Normale}
\label{sec:org6ffc037}
...
\label{sec:org043df23}
\subsection{Enfant}
\label{sec:orgde44e81}
...
\label{sec:orgec8d4c2}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orgc1650d5}
...
\label{sec:org9f07ac1}
\subsubsection{Interrogatoire}
\label{sec:org80a5d22}
\begin{itemize}
...
\label{sec:org6c20db9}
\subsubsection{Androgènes circulants}
\label{sec:org657f8d6}
...
\label{sec:orgb78732f}
À partir du stade 2

\subsubsection{Saignées}
\label{sec:orgea7b42e}
...
\label{sec:orgd16033e}
\subsubsection{Auto-immunes}
\label{sec:org71d16c4}
\paragraph{Maladie de Basedow}
\label{sec:org8563200}
...
\subsection{Étiologies}
\label{sec:orgfecef8e}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org328e880}
Auto-immunes :
\begin{itemize}
...
\label{sec:org09ff890}
\subsection{Sd tumoral}
\label{sec:org2eb622d}
Clinique : 
\begin{itemize}
...
\label{sec:orgd6bf31d}
\subsubsection{Hyperprolactinémie}
\label{sec:org89cdbbd}
...
\label{sec:org0c766bb}
\subsection{Insuffisance surrénale lente}
\label{sec:org9426e8b}
...
\label{sec:orge9febe7}
\subsubsection{Y penser}
\label{sec:org4661e6f}
\begin{itemize}
...
\label{sec:org3b60bb0}
\paragraph{Déf}
\label{sec:orgff374c7}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org25411c1}}, proprioceptiques\textsuperscript{\ref{org25411c1}}
\begin{itemize}
...
\label{sec:org97e3a30}
Fréquent

\subsection{Interrogatoire}
\label{sec:org77a660f}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org8e003c7}
\subsection{Adulte}
\label{sec:orgd2af5e5}
...
\label{sec:org44eb61d}
\subsection{Examen d'aptitude}
\label{sec:orgb56d00c}
...
\label{sec:orgc56f45a}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:org0627cc3}
...
\label{sec:org68d8b84}
\subsection{Sécrétant des oestrogènes}
\label{sec:orgff90cb8}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[55]{\label{orgebab232}Oestro-gastro-duodénaux}
