...
\label{sec:orgac9808b}
\subsection{Contraception hormonale}
\label{sec:org556ffb3}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org299bfcf}
\subsubsection{Primaire}
\label{sec:orgefd9fde}
...
\label{sec:org621313a}
\begin{enumerate}
\item SOPK (majorité)
\label{sec:orgc9b1a25}
...
\label{sec:org98d2e60}
\begin{enumerate}
\item Congénitales :
\label{sec:org4b49b35}
...
\item Secondaires :
\label{sec:org22f386a}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\end{enumerate}
\section{47 : Puberté}
\label{sec:orge662087}
\subsection{Normale}
\label{sec:orgf1b28d5}
...
\label{sec:org600f037}
\subsection{Enfant}
\label{sec:org7d82b1d}
...
\label{sec:orgbe63082}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orgbdc92ca}
...
\label{sec:orga3191af}
\subsubsection{Interrogatoire}
\label{sec:org7d606b1}
\begin{itemize}
...
\label{sec:org62a032e}
\subsubsection{Androgènes circulants}
\label{sec:org48fc1a4}
