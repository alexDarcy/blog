...
\label{sec:org98bd235}
\subsection{Contraception hormonale}
\label{sec:orgc9f5c1f}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgd30adcf}
\subsubsection{Primaire}
\label{sec:org1d3ca50}
...
\label{sec:orga169bc0}
\begin{enumerate}
\item SOPK (majorité)
\label{sec:org9ed2995}
...
\label{sec:org271a350}
\begin{enumerate}
\item Congénitales :
\label{sec:org5006c49}
...
\item Secondaires :
\label{sec:org98b7d84}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\end{enumerate}
\section{47 : Puberté}
\label{sec:org7bdbd31}
\subsection{Normale}
\label{sec:org2fd77c4}
...
\label{sec:org73f89f2}
\subsection{Enfant}
\label{sec:orgdf02d07}
