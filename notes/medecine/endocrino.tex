...
\label{sec:org1b9ba27}
\subsection{Contraception hormonale}
\label{sec:org9182d29}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgd7b022a}
\subsubsection{Primaire}
\label{sec:org45848a5}
...
\label{sec:orgaf0bc9a}
\paragraph{SOPK (majorité)}
\label{sec:org2efee42}
...
\label{sec:org3446e17}
\paragraph{Congénitales}
\label{sec:org2feca3d}
...
\label{sec:orgab26c7d}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:orgb00d463}
\subsection{Normale}
\label{sec:org04ad5b7}
...
\label{sec:org0e961ae}
\subsection{Enfant}
\label{sec:org605bddb}
...
\label{sec:org63bc04c}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:org45add7f}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:org70725a3}. Précisions :
\begin{itemize}
...
\label{sec:orgd933fb4}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org89758b6}
...
\label{sec:orgf616516}
\subsubsection{Interrogatoire}
\label{sec:org383c6e7}
\begin{itemize}
...
\label{sec:orgf35d225}
\subsubsection{Androgènes circulants}
\label{sec:org9e63a0d}
...
\label{sec:orgbf37e27}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org452f9f1}
...
\label{sec:org0d040d5}
\subsubsection{Auto-immunes}
\label{sec:orgd90a7b2}
...
\subsection{Étiologies}
\label{sec:orgced4c87}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org59c30e4}
Auto-immunes :
\begin{itemize}
...
\label{sec:org85cfb3b}
\subsection{Sd tumoral}
\label{sec:org04cd9e2}
Clinique : 
\begin{itemize}
...
\label{sec:orgf8b5553}
\subsection{Insuffisance surrénale lente}
\label{sec:org2fa9f7b}
...
\label{sec:orgbe1757d}
\subsubsection{Y penser}
\label{sec:orgf32bc09}
\begin{itemize}
...
Traitement insulinique (Table \ref{tab:org7335512} ): palliatif à vie

\begin{table}[htbp]
\caption{\label{tab:org7335512}
...
\label{sec:orga92206c}
\paragraph{Déf}
\label{sec:orgde435e5}
...
Examen 
\begin{itemize}
\item clinique : interrogatoire (hypotension OS, diarrhée\ldots{}), inspection pieds, ROT abolis au niveau des troubles sensitifs, monofilament, sensibilité épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org4c47609}}, proprioceptiques\textsuperscript{\ref{org4c47609}}
...
\label{sec:orgf3f33cc}
Fréquent

\subsection{Interrogatoire}
\label{sec:org507535f}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org1edcbbb}
\subsection{Adulte}
\label{sec:orgfc82b11}
...
\label{sec:orga7add50}
\subsection{Examen d'aptitude}
\label{sec:org4366ff8}
...
\label{sec:org29b6efb}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:org71fc5a7}
...
\label{sec:org2ba5c36}
\subsection{Sécrétant des oestrogènes}
\label{sec:org0bac348}
...
\section{Annexes}
\label{sec:org8b79e76}
\subsection{Hormones}
\label{sec:org7b13437}
