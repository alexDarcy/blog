...
\label{sec:org818212c}
\subsection{Contraception hormonale}
\label{sec:orgbdf4a54}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgffadf3d}
\subsubsection{Primaire}
\label{sec:orgaf7d58e}
...
\label{sec:orgcb3108e}
\paragraph{SOPK (majorité)}
\label{sec:org1df649e}
...
\label{sec:orgdd69df6}
\paragraph{Congénitales}
\label{sec:org015c0d3}
...
\label{sec:orgb95fab2}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org87186f4}
\subsection{Normale}
\label{sec:orge812d53}
...
\label{sec:org8e85073}
\subsection{Enfant}
\label{sec:org393d855}
...
\label{sec:orgdea2436}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:orgc770142}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:org6df43b5}. Précisions :
\begin{itemize}
...
\label{sec:orga225d55}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org3eda6e4}
...
\label{sec:orgd5d02a1}
\subsubsection{Interrogatoire}
\label{sec:org4e658c6}
\begin{itemize}
...
\label{sec:org8894335}
\subsubsection{Androgènes circulants}
\label{sec:org7569911}
...
\label{sec:orga283d69}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org9482a6f}
...
\label{sec:org43efe89}
\subsubsection{Auto-immunes}
\label{sec:orgad99c82}
\paragraph{Maladie de Basedow}
\label{sec:orgb6fc0e3}
...
\subsection{Étiologies}
\label{sec:org41eb047}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org6757f27}
Auto-immunes :
\begin{itemize}
...
\label{sec:orge513d5f}
\subsection{Sd tumoral}
\label{sec:org11c23b1}
Clinique : 
\begin{itemize}
...
\label{sec:orgd048155}
\subsubsection{Hyperprolactinémie}
\label{sec:org18dc37f}
...
\label{sec:orge684620}
\subsection{Insuffisance surrénale lente}
\label{sec:org99e970f}
...
\label{sec:org168ad22}
\subsubsection{Y penser}
\label{sec:org17bf22a}
\begin{itemize}
...
\label{sec:orgc49477b}
\paragraph{Déf}
\label{sec:orgf50d9e8}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org4c471ab}}, proprioceptiques\textsuperscript{\ref{org4c471ab}}
\begin{itemize}
...
\label{sec:org9b1ca5a}
Fréquent

\subsection{Interrogatoire}
\label{sec:org5369fa6}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org53c5baa}
\subsection{Adulte}
\label{sec:orgd3c8351}
...
\label{sec:org5d4761b}
\subsection{Examen d'aptitude}
\label{sec:org6cfb919}
...
\label{sec:orgd25d86b}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orga98dfeb}
...
\label{sec:org1443273}
\subsection{Sécrétant des oestrogènes}
\label{sec:orgef4fcc4}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[59]{\label{orgd2cd51f}Oestro-gastro-duodénaux}
