...
\label{sec:org5d489cb}
\subsection{Contraception hormonale}
\label{sec:org389551c}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org47839cc}
\subsubsection{Primaire}
\label{sec:org2e66592}
...
\label{sec:orge12a6a8}
\paragraph{SOPK (majorité)}
\label{sec:org69eac34}
...
\label{sec:org3ec074f}
\paragraph{Congénitales}
\label{sec:orge9394ee}
...
\label{sec:orgefc7cd4}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:orgc21f175}
\subsection{Normale}
\label{sec:orga078e81}
...
\label{sec:orge66210d}
\subsection{Enfant}
\label{sec:orga52cefb}
...
\label{sec:org8066a95}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:orgad8fb34}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:org00e01af}. Précisions :
\begin{itemize}
...
\label{sec:org65f8b13}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orgec4a2e4}
...
\label{sec:org6e50dd1}
\subsubsection{Interrogatoire}
\label{sec:org327ae2b}
\begin{itemize}
...
\label{sec:org10a3baf}
\subsubsection{Androgènes circulants}
\label{sec:org03a55d5}
...
\label{sec:orgd1d60fb}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org8a668a4}
...
\label{sec:org159a06c}
\subsubsection{Auto-immunes}
\label{sec:org9ec3c7b}
...
\subsection{Étiologies}
\label{sec:orgbf82aeb}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org2bdc118}
Auto-immunes :
\begin{itemize}
...
\label{sec:org21602d2}
\subsection{Sd tumoral}
\label{sec:org9c3fcf5}
Clinique : 
\begin{itemize}
...
\label{sec:orgd9116e8}
\subsection{Insuffisance surrénale lente}
\label{sec:org7a22cca}
...
\label{sec:org76f58e0}
\subsubsection{Y penser}
\label{sec:orgc7157b6}
\begin{itemize}
...
Traitement insulinique (Table \ref{tab:orga412e09} ): palliatif à vie

\begin{table}[htbp]
\caption{\label{tab:orga412e09}
...
\label{sec:org9fdc10c}
\paragraph{Déf}
\label{sec:orgfae4825}
...
Examen 
\begin{itemize}
\item clinique : interrogatoire (hypotension OS, diarrhée\ldots{}), inspection pieds, ROT abolis au niveau des troubles sensitifs, monofilament, sensibilité épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{orga5eac74}}, proprioceptiques\textsuperscript{\ref{orga5eac74}}
...
\label{sec:org6e4e440}
Fréquent

\subsection{Interrogatoire}
\label{sec:org74026db}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org7f260ed}
\subsection{Adulte}
\label{sec:orgd10b2d3}
...
\label{sec:orgdacd13f}
\subsection{Examen d'aptitude}
\label{sec:org57ca1c3}
...
\label{sec:org9d05fbe}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:org6fbdb00}
...
\label{sec:org7d5ed0d}
\subsection{Sécrétant des oestrogènes}
\label{sec:org934a77b}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[63]{\label{orgdc52977}Oestro-gastro-duodénaux}
...
\section{Annexes}
\label{sec:orga39cb2f}
\subsection{Hormones}
\label{sec:org733b273}
