...
\subsection{Conduite}
\label{sec:orgbde886a}
\subsubsection{Primaire}
\label{sec:orge2a917e}
...
\label{sec:orgbc4ae1d}
\subsection{Enfant}
\label{sec:orgda4e18d}
...
\label{sec:orgaccd7a5}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org81b9bd8}
...
\label{sec:orgf53e25b}
\subsubsection{Auto-immunes}
\label{sec:org00ed7de}
\paragraph{Maladie de Basedow}
\label{sec:org1351cc8}
...
\subsection{Étiologies}
\label{sec:orgf3e451c}
\subsubsection{Hypothyroïdie primaire}
\label{sec:orga6fb9a3}
Auto-immunes :
\begin{itemize}
...
\label{sec:orgbde3c75}
\subsection{Sd tumoral}
\label{sec:org17e0fcc}
Clinique : 
\begin{itemize}
...
\label{sec:orgcbb05f5}
\subsubsection{Hyperprolactinémie}
\label{sec:orge7db489}
...
\label{sec:org5a02311}
\subsection{Insuffisance surrénale lente}
\label{sec:orgc1c71dd}
...
\label{sec:org3018afe}
\subsubsection{Y penser}
\label{sec:orgf7118aa}
\begin{itemize}
...
\label{sec:orgcffef3b}
\paragraph{Déf}
\label{sec:org8483d26}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org5f13bea}}, proprioceptiques\textsuperscript{\ref{org5f13bea}}
\begin{itemize}
...
\label{sec:org4484f41}
Fréquent

\subsection{Interrogatoire}
\label{sec:orgf6fd317}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org7c3e5b0}
\subsection{Adulte}
\label{sec:org985d797}
...
\label{sec:orgf7343df}
\subsection{Examen d'aptitude}
\label{sec:orgeae5acb}
...
\label{sec:orgd090bd4}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgdd72091}
...
\label{sec:orgb7587e1}
\subsection{Sécrétant des oestrogènes}
\label{sec:org431a693}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[55]{\label{orgd238882}Oestro-gastro-duodénaux}
