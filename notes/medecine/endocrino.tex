...
\label{sec:org2fee109}
\subsection{Contraception hormonale}
\label{sec:orgce69b7f}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org7f8a037}
\subsubsection{Primaire}
\label{sec:org159136d}
...
\label{sec:orgd7fdbed}
\paragraph{SOPK (majorité)}
\label{sec:orgb216325}
...
\label{sec:org497d1ba}
\paragraph{Congénitales}
\label{sec:org751a3f6}
...
\label{sec:org8ff3d92}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org82f92ef}
\subsection{Normale}
\label{sec:org0219fed}
...
\label{sec:org5e1a419}
\subsection{Enfant}
\label{sec:orgf87cfd5}
...
\label{sec:org8456715}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:orgf930130}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:org1c6b93b}. Précisions :
\begin{itemize}
...
\label{sec:org085011c}
\label{sec:120}
\subsection{Ménopause}
\label{sec:org9ac1a1f}
...
\label{sec:org4f8c2f1}
\subsubsection{Interrogatoire}
\label{sec:orgd8cce2d}
\begin{itemize}
...
\label{sec:orgdc83076}
\subsubsection{Androgènes circulants}
\label{sec:org30085c1}
...
\label{sec:org58b9815}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org420e743}
...
\item Étude génétique dans tous les cas : positif \thus chercher phéochromocytome,
\end{itemize}
hyperparathyroïdie + enquêtes apparentés
\section{240 : Hyperthyroïdie}
\label{sec:org1ad968a}
...
\label{sec:org5ef330e}
\subsubsection{Auto-immunes}
\label{sec:orgbc65b99}
\paragraph{Maladie de Basedow}
\label{sec:org2a970c6}
...
\subsection{Étiologies}
\label{sec:org0f9a948}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org035e111}
Auto-immunes :
\begin{itemize}
...
\label{sec:orgbe9846d}
\subsection{Sd tumoral}
\label{sec:orgb2f2458}
Clinique : 
\begin{itemize}
...
\label{sec:orgbe748f9}
\subsubsection{Hyperprolactinémie}
\label{sec:org8e3f5d6}
...
\label{sec:orgeda009a}
\subsection{Insuffisance surrénale lente}
\label{sec:orga8a78e7}
...
\label{sec:orgd9b51da}
\subsubsection{Y penser}
\label{sec:org102414f}
\begin{itemize}
...
\label{sec:org083442e}
\paragraph{Déf}
\label{sec:org6140692}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org9326913}}, proprioceptiques\textsuperscript{\ref{org9326913}}
\begin{itemize}
...
\label{sec:orgbecbb74}
Fréquent

\subsection{Interrogatoire}
\label{sec:org8247e36}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org8dcdb71}
\subsection{Adulte}
\label{sec:org89642fe}
...
\label{sec:org18d6baa}
\subsection{Examen d'aptitude}
\label{sec:orga4857d4}
...
\label{sec:org39f69e8}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgbb1268c}
...
\label{sec:org052174a}
\subsection{Sécrétant des oestrogènes}
\label{sec:org2c4d02f}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[60]{\label{org2ac2a50}Oestro-gastro-duodénaux}
