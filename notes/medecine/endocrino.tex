...
\label{sec:orgb112778}
\subsection{Contraception hormonale}
\label{sec:org0e5d537}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgd84b86f}
\subsubsection{Primaire}
\label{sec:org5f9c9ce}
...
\label{sec:org280785c}
\paragraph{SOPK (majorité)}
\label{sec:org2ad0112}
...
\label{sec:orge1520fc}
\paragraph{Congénitales}
\label{sec:org755272b}
...
\subsection{Étiologies}
\label{sec:org075d1b9}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org55845cd}
Auto-immunes :
\begin{itemize}
...
\label{sec:orgd6ffe2a}
\paragraph{Déf}
\label{sec:org8a77ad1}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org136beab}}, proprioceptiques\textsuperscript{\ref{org136beab}}
\begin{itemize}
...
\label{sec:org9128d06}
Fréquent

\subsection{Interrogatoire}
\label{sec:org815622e}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org7580368}
\subsection{Adulte}
\label{sec:org67420d3}
...
\label{sec:orgf858f54}
\subsection{Examen d'aptitude}
\label{sec:org4243b17}
...
\label{sec:org658f9da}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgc7dff5e}
...
\label{sec:orgc47eb79}
\subsection{Sécrétant des oestrogènes}
\label{sec:org45c04b2}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[61]{\label{org5c70b78}Oestro-gastro-duodénaux}
...
\section{Annexes}
\label{sec:orge54e26d}
\subsection{Hormones}
\label{sec:orgd714c36}
