...
\label{sec:orgf7ac0cc}
\subsection{Contraception hormonale}
\label{sec:orgefb47f2}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgb499e53}
\subsubsection{Primaire}
\label{sec:org1d3d40b}
...
\label{sec:org49de448}
\paragraph{SOPK (majorité)}
\label{sec:orgdc8a751}
...
\label{sec:org61060d1}
\paragraph{Congénitales}
\label{sec:org93f9921}
...
\label{sec:org0d22d7c}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org5a2c6c5}
\subsection{Normale}
\label{sec:org46b9f34}
...
\label{sec:org1bb83f0}
\subsection{Enfant}
\label{sec:orgba6f30f}
...
\label{sec:orgfe4f21a}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:orgd79e923}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:orgb96f7af}. Précisions :
\begin{itemize}
...
\label{sec:orgceb0c29}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orgcb3bb61}
...
\label{sec:org0573025}
\subsubsection{Interrogatoire}
\label{sec:org20f24a9}
\begin{itemize}
...
\label{sec:org13ed3ad}
\subsubsection{Androgènes circulants}
\label{sec:orgd40188a}
...
\label{sec:org7ae11fc}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org93232d8}
...
\label{sec:orgea31227}
\subsubsection{Auto-immunes}
\label{sec:org0c7b6d4}
...
\subsection{Étiologies}
\label{sec:org8be5bac}
\subsubsection{Hypothyroïdie primaire}
\label{sec:orgf87f26c}
Auto-immunes :
\begin{itemize}
...
\label{sec:orgdc802ff}
\subsection{Sd tumoral}
\label{sec:org8367a97}
Clinique : 
\begin{itemize}
...
\label{sec:org68c3ad3}
\subsection{Insuffisance surrénale lente}
\label{sec:org1c7c09c}
...
\label{sec:org29adceb}
\subsubsection{Y penser}
\label{sec:org549f8ba}
\begin{itemize}
...
Traitement insulinique (Table \ref{tab:org1b2bf08} ): palliatif à vie

\begin{table}[htbp]
\caption{\label{tab:org1b2bf08}
...
\label{sec:org19ca980}
\paragraph{Déf}
\label{sec:orgcc057e3}
...
Examen 
\begin{itemize}
\item clinique : interrogatoire (hypotension OS, diarrhée\ldots{}), inspection pieds, ROT abolis au niveau des troubles sensitifs, monofilament, sensibilité épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{orgdfc6be7}}, proprioceptiques\textsuperscript{\ref{orgdfc6be7}}
...
\label{sec:orgc2cdc90}
Fréquent

\subsection{Interrogatoire}
\label{sec:org442cfd4}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org9264c56}
\subsection{Adulte}
\label{sec:org4b94cb6}
...
\label{sec:orgb4515aa}
\subsection{Examen d'aptitude}
\label{sec:orga1112f2}
...
\label{sec:orgfef4b9c}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:org014b1b9}
...
\label{sec:orge9b9600}
\subsection{Sécrétant des oestrogènes}
\label{sec:org12173a8}
...
\section{Annexes}
\label{sec:org0db3f11}
\subsection{Hormones}
\label{sec:org20d862e}
