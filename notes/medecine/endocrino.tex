...
\label{sec:org6bc06b9}
\subsection{Contraception hormonale}
\label{sec:org0f78c18}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgb1ccc20}
\subsubsection{Primaire}
\label{sec:org3b6d71a}
...
\label{sec:orgbd5e2d0}
\paragraph{SOPK (majorité)}
\label{sec:org9faae6f}
...
\label{sec:orgb1f43d8}
\paragraph{Congénitales}
\label{sec:org4aafd03}
...
\subsection{Étiologies}
\label{sec:org6c38ba0}
\subsubsection{Hypothyroïdie primaire}
\label{sec:orgd0dc6bf}
Auto-immunes :
\begin{itemize}
...
\label{sec:org1f490d3}
\subsection{Examen d'aptitude}
\label{sec:orgb426275}
...
\label{sec:org9a3850b}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:org4f0c7fb}
...
\label{sec:org61ce589}
\subsection{Sécrétant des oestrogènes}
\label{sec:org1cad66f}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[64]{\label{orgd48327d}Oestro-gastro-duodénaux}
...
\section{Annexes}
\label{sec:org6dcb0b7}
\subsection{Hormones}
\label{sec:orgdbb6768}
