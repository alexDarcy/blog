...
\label{sec:org3c6ad87}
\subsection{Contraception hormonale}
\label{sec:org8f3fbdb}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:org3a07fd3}
\subsubsection{Primaire}
\label{sec:orgc8a9a25}
...
\label{sec:org8b67671}
\paragraph{SOPK (majorité)}
\label{sec:org2e8e277}
...
\label{sec:org45af328}
\paragraph{Congénitales}
\label{sec:orgdf45039}
...
\label{sec:org4341e29}
\subsection{Enfant}
\label{sec:orgbbc5a87}
...
\label{sec:orga1faa6b}
\begin{itemize}
\item Si poids < poids idéal : cf table \ref{tab:orgb2042be}
\item Si poids \(\ge\) poids idéal : cf table \ref{tab:org65dd067}. Précisions :
\begin{itemize}
...
\label{sec:orgccf2b55}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orgc6751a9}
...
\label{sec:org233bc63}
\subsubsection{Interrogatoire}
\label{sec:orgafbbcce}
\begin{itemize}
...
\label{sec:orgaf03ef4}
\subsubsection{Androgènes circulants}
\label{sec:org563c8a2}
...
\label{sec:org1a824f2}
À partir du stade 2

\subsubsection{Saignées = référence}
\label{sec:org43cbaac}
...
\label{sec:orga3b0efb}
\subsubsection{Auto-immunes}
\label{sec:org96b2f75}
...
\subsection{Étiologies}
\label{sec:org738bec6}
\subsubsection{Hypothyroïdie primaire}
\label{sec:orgcd64cbc}
Auto-immunes :
\begin{itemize}
...
\label{sec:orgdcae9f6}
\subsection{Sd tumoral}
\label{sec:orgb19545e}
Clinique : 
\begin{itemize}
...
\label{sec:org64b9bd2}
\subsubsection{Hyperprolactinémie}
\label{sec:orgbd7f257}
...
\label{sec:org17ebfe4}
\subsection{Insuffisance surrénale lente}
\label{sec:org87542b7}
...
\label{sec:org728ca2c}
\subsubsection{Y penser}
\label{sec:org1fdd815}
\begin{itemize}
...
\label{sec:orgde20ed9}
\paragraph{Déf}
\label{sec:org03de54a}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{orga33d24f}}, proprioceptiques\textsuperscript{\ref{orga33d24f}}
\begin{itemize}
...
\label{sec:org7fe7190}
Fréquent

\subsection{Interrogatoire}
\label{sec:orgfc47d97}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:org271a2cc}
\subsection{Adulte}
\label{sec:org15e3a30}
...
\label{sec:org6507df1}
\subsection{Examen d'aptitude}
\label{sec:orga3be870}
...
\label{sec:orgaedd8b7}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgf4b309d}
...
\label{sec:orgcb4c9aa}
\subsection{Sécrétant des oestrogènes}
\label{sec:org24584fa}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[60]{\label{org0651653}Oestro-gastro-duodénaux}
