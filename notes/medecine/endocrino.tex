...
\label{sec:orgead058b}
\subsection{Contraception hormonale}
\label{sec:org1175b66}
Oestroprogestatifs
\begin{itemize}
...
\subsection{Conduite}
\label{sec:orgb469072}
\subsubsection{Primaire}
\label{sec:org337b9f7}
...
\label{sec:org4ee5367}
\paragraph{SOPK (majorité)}
\label{sec:orgb173edf}
...
\label{sec:org8110fb3}
\paragraph{Congénitales :}
\label{sec:org4be75d1}
...
\label{sec:orga2707e0}
Synéchies utérines (trauma de l'utérus), tuberculose utérine
\section{47 : Puberté}
\label{sec:org7ba78a7}
\subsection{Normale}
\label{sec:org33b72d0}
...
\label{sec:org01673d2}
\subsection{Enfant}
\label{sec:orgf35f758}
...
\label{sec:orgc658315}
\label{sec:120}
\subsection{Ménopause}
\label{sec:orga460509}
...
\label{sec:orgbff352f}
\subsubsection{Interrogatoire}
\label{sec:orgf6b15db}
\begin{itemize}
...
\label{sec:org2c8a839}
\subsubsection{Androgènes circulants}
\label{sec:org66cc219}
...
\label{sec:org9c394c9}
À partir du stade 2

\subsubsection{Saignées}
\label{sec:orgd22c7b1}
...
\subsection{Étiologies}
\label{sec:org008db06}
\subsubsection{Hypothyroïdie primaire}
\label{sec:org00fbe26}
Auto-immunes :
\begin{itemize}
...
\label{sec:org19a4046}
\subsection{Sd tumoral}
\label{sec:org4b6800d}
Clinique : 
\begin{itemize}
...
\label{sec:org370d771}
\subsubsection{Hyperprolactinémie}
\label{sec:org2fb3cd0}
...
\label{sec:org3df1b93}
\subsection{Insuffisance surrénale lente}
\label{sec:org577bc08}
...
\label{sec:org1396710}
\subsubsection{Y penser}
\label{sec:orge804c81}
\begin{itemize}
...
\label{sec:org83c2d9d}
\paragraph{Déf}
\label{sec:org1551dda}
...
épicritique, thermoalgique, vibratoire\footnote{Grosses fibres\label{org1420674}}, proprioceptiques\textsuperscript{\ref{org1420674}}
\begin{itemize}
...
\label{sec:org587cf0f}
Fréquent

\subsection{Interrogatoire}
\label{sec:orge5676d4}
\begin{itemize}
...
\end{itemize}
\section{251 : Obésité}
\label{sec:orgf8dfa7c}
\subsection{Adulte}
\label{sec:orgeb03d4a}
...
\label{sec:orgc24a753}
\subsection{Examen d'aptitude}
\label{sec:orgf2f79de}
...
\label{sec:org4ec491c}

\subsection{Hypocalcémie (hypoCa)}
\label{sec:orgb3bca71}
...
\label{sec:org0078687}
\subsection{Sécrétant des oestrogènes}
\label{sec:org0ec84a9}
...
\bottomrule
\end{tabular}
\end{center}\footnotetext[55]{\label{org7c7313c}Oestro-gastro-duodénaux}
