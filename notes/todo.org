...
*** TODO Vérifier remboursement (1 mois, donc vers 15 août)
...
**** Emacs config from scratch : evil, org-mode
**** Doom emacs
**** Calc
...
**** TODO Post config en japo sur emacs :blog:
Archlinux :
...
*** TODO Mousse de chocolat au jus de pois-chiche
*** TODO Scones : livre rose. Levure mal mélangée. À refaire
...
** TODO Ouverture de stage en génétique été 2020
*** DONE Vérifier que stage non ouvert
*** DONE Accord chef de service
Mail envoyé <2020-04-28 Tue>
*** WAITING Accord de la fac (répartition)
** TODO Vérifier paiement gardes covid
*** TODO Mercy mars
Manque
*** TODO Mercy avril
*** DONE Nancy
** TODO Retirer ECNI intesfi
*** TODO Demande faite <2020-06-02 Tue>
* Gymnastics :gym:
** TODO Splits :daily:
...
SCHEDULED: <2020-06-04 Thu .+1d>
:PROPERTIES:
:STYLE:    habit
:LAST_REPEAT: [2020-06-03 Wed 21:12]
:END:
...
** TODO Backflip on trampoline :daily:
   SCHEDULED: <2020-06-07 Sun .+1d>
   :PROPERTIES:
   :STYLE:    habit
   :LAST_REPEAT: [2020-06-06 Sat 17:26]
   :END:
...
:END:
** TODO Japanesepod101
*** DONE Beginner S1 (170)
*** DONE Begdinner S4
*** TODO Upper beginner S1
**** TODO Lire leçon
**** DONE Audio
...
*** TODO Tri en cours
** TODO Souder la cloture à l'arrière du jardin                                 :été2019:
** WAITING Virement rente
*** DONE Mail envoyé
...
SCHEDULED: <2020-05-20 Wed .+1d>
:PROPERTIES:
:LAST_REPEAT: [2020-05-19 Tue 22:18]
:STYLE:    habit
