#+TODO: TODO(t) RETRY(r) | DONE(d) AVOID(a)
...
** Haricots blancs
*** AVOID NYT: haricots blancs crémeux
  https://cooking.nytimes.com/recipes/1019385-creamy-white-beans-with-herb-oil
  Citron et haricots blancs ne vont pas trop ensemble
...
:PROPERTIES:
:source-url: https://cooking.nytimes.com/recipes/1020862-beef-stroganoff?action=click&module=Global%20Search%20Recipe%20Card&pgType=search&rank=1
:servings:
:prep-time:
:cook-time:
:ready-in: 1 hour
