...
* TODO Liste des livres sur askhistorians
...
*** TODO Utiliser la liste sur goodreadrs
...
**** TODO Récupérer catégories
** TODO Résultats sur Mam
Rerchere automatique et fait à la main
*** DONE Parser liste des auteurs
*** TODO Calculer la distance de levensein sur le titre
*** TODO Filtrer sur l'auteur (distance de levenstein ?)
*** TODO Créer un Tree avec les categories
** TODO Post final
*** TODO Formatter depuis CSV
...
*** TODO Condorcet
**** TODO Écrits sur les États-Unis
https://classiques-garnier.com/ecrits-sur-les-etats-unis-1.html
*** TODO Confucius
**** TODO Doctrine ou les Quatre Livres de philosophie morale et politique de la Chine
...
URL pour PDF:
load_pdf.php?ID_ARTICLE=PERRI_MOUTO_2018_01_0011&download=1

Chaque groupe de chapitre a son ID qui est dans le HTML apparemment (data-id-article)
<!-- Meta-Data : Numéro de revue -->
<div id="tuile-9f7c63c406cce10bd13030c3629359591e0ad6fe606381956132b" class="media wow fadeIn isSommaire  well article-list-item" data-id-revue="PERRI_HC" date-id-numero="PERRI_MOUTO_2018_01" data-id-article="PERRI_MOUTO_2018_01_0031">
