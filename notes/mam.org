...
*** Algorithme
Pour un chapitre
L'URL pour PDF a changé. Il faut aller dans feuilleter.php?ID_ARTICLE=PERRI_MOUTO_2018_01_0011
Et récupérer dans le javascript caché, la variable parametersViewer qui contient dans file le lien vers le PDF (avec un token que l'on ne trouve nulle par ailleur)
