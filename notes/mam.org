...
testUpload = do
   let url ="https://lol/takelogin.php"
   sess <- S.newSession
   ...
   -- mapM print $ T.lines $ TE.decodeUtf8 $ r ^. responseBody
   -- r ^. responseBody . key "form" -- headers" . _String -- . key "Content-Type" . _String
input = [partText (T.toStrict "MAX_FILE_SIZE") (T.toStrict "100"),
         partFileSource "torrent" "Htest.torrent",
         partText (T.toStrict "submit") (T.toStrict "Submit")]
-- input = ["filename" := ("lol"  :: String)]

#+end_src

**** TODO tentative 2 = success
#+begin_src haskell
