...
*** 2021-07-08 Thursday
**** Parkour
   Technique: roll, side, kong, passe-muraille

*** 2021-07-09 Friday
**** Handstand
    StW 41-32
    BtW 2-2x3-4-5-6
    Btw (tête regardant le sol) 9
**** Running
     :PROPERTIES:
     :type:     sprint
     :reps:     8
...
**** Workout
   Skin-the-cat : 2-2
   L-sit : 9-9 (!)
   Muscle-up : 3x1 (bras légèrement pliés) - 4x1 (bras tendus) - 4x1 (!!)
   Pistols (assisted) : 3x 4#4
   Extension (lower-back) : 3x22
   Front-lever row (tuck) : 3x{1+1}
   Planche on rings (tuck): 3x{3+2}
   Norwegian curls: 2x4-5
   Compression : 3x10
